...
@Component({
  selector: 'app-camaras-cuanticas',
  templateUrl: './camaras-cuanticas.page.html',
  styleUrls: ['./camaras-cuanticas.page.scss'],
})
export class CamarasCuanticasPage implements OnInit {
  paramInter = null;
  ...
  secionsAndTracks(){
    this.apiService.tracksDash('4').subscribe( response => {
